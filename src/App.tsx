      ...
      <main>
        ...
        <section className="pt-40 pb-20 px-8 max-w-7xl mx-auto min-h-[90vh] flex flex-col md:flex-row items-center gap-16 md:gap-24">
          <div className="flex-1 space-y-10">
            <h1 className="font-serif text-6xl md:text-9xl leading-[1.1] tracking-tight font-light">
              MAHEUN
            </h1>
          ...
          <div className="flex-1 perspective-1000 hidden md:flex justify-center">
        ...
        <section className="bg-parchment/30 py-32 px-8">
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-12 text-charcoal/80 leading-relaxed">
              <p>
        ...
        <section className="py-32 px-8 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
          <div className="w-full md:w-1/2 aspect-[4/5] bg-parchment">
            <img 
